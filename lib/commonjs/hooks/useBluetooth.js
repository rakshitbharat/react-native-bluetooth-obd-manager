...
const useBluetooth = () => {
  ...
  const connectToDevice = (0, _react.useCallback)(async deviceId => {
    ...
    try {
      ...
      (_connectPromiseRef$cu2 = connectPromiseRef.current) === null || _connectPromiseRef$cu2 === void 0 || _connectPromiseRef$cu2.reject(error);
      connectPromiseRef.current = null; // Clear ref
  ...
  const disconnect = (0, _react.useCallback)(async () => {
    ...
    try {
      ...
      (_disconnectPromiseRef3 = disconnectPromiseRef.current) === null || _disconnectPromiseRef3 === void 0 || _disconnectPromiseRef3.reject(error);
  ...
  (0, _react.useEffect)(() => {
    ...
    if (state.isAwaitingResponse && currentCommandRef.current) {
      ...
      if (promptIndex !== -1) {
        ...
        (_currentCommandRef$cu5 = currentCommandRef.current) === null || _currentCommandRef$cu5 === void 0 || _currentCommandRef$cu5.promise.resolve(responseString);
