...
const mockEmitter = {
  addListener: jest.fn(() => ({ remove: jest.fn() })), // Return an object with a remove function
  removeListener: jest.fn(), // Though usually remove() on the listener object is used
  removeAllListeners: jest.fn(),
  // Add other methods if needed, but addListener is primary
};

// Type mockEmitter explicitly
const MockNativeEventEmitter = jest.fn().mockImplementation(() => mockEmitter) as jest.MockedClass<any>;
...
const BleManager = {
  ...
  retrieveServices: jest.fn((peripheralId: string) => // Simulate service discovery
    Promise.resolve({
      id: peripheralId,
      name: 'MockDevice',
      rssi: -50,
      ...
      characteristics: [
        ...
        { service: '00001101-0000-1000-8000-00805F9B34FB', characteristic: '0000FFE1-0000-1000-8000-00805F9B34FB', properties: { WriteWithoutResponse: 'WriteWithoutResponse', Notify: 'Notify' } },
        { service: '0000FFE0-0000-1000-8000-00805F9B34FB', characteristic: '0000FFE1-0000-1000-8000-00805F9B34FB', properties: { WriteWithoutResponse: 'WriteWithoutResponse', Notify: 'Notify' } },
        { service: 'E7810A71-73AE-499D-8C15-FAA9AEF0C3F2', characteristic: 'BE781A71-73AE-499D-8C15-FAA9AEF0C3F2', properties: { Write: 'Write', Notify: 'Notify' } }, // VLinker supports Write
      ],
    })
  ),
...
export function emitBleManagerEvent(eventName: string, data: any): void {
    ...
    const mockListener = mockEmitter.addListener.mock.calls.find(call => Array.isArray(call) && call[0] === eventName);
    if (mockListener && typeof mockListener[1] === 'function') {
        mockListener[1](data); // Call the callback function with data
    } else {
