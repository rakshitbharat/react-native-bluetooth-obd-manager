...
export class OBDManager {
  ...
  public getProtocolName(): string {
    switch (this.protocol) {
      case OBDProtocol.AUTO:
        return 'Auto';
      case OBDProtocol.J1850PWM:
        return 'SAE J1850 PWM';
      case OBDProtocol.J1850VPW:
        return 'SAE J1850 VPW';
      case OBDProtocol.ISO9141:
        return 'ISO 9141-2';
      case OBDProtocol.ISO14230_4KW:
        return 'ISO 14230-4 (KWP2000 Fast)';
      case OBDProtocol.ISO14230_4ST:
        return 'ISO 14230-4 (KWP2000 Slow)';
      case OBDProtocol.ISO15765_11_500:
        return 'ISO 15765-4 (CAN 11bit 500K)';
      case OBDProtocol.ISO15765_29_500:
        return 'ISO 15765-4 (CAN 29bit 500K)';
      case OBDProtocol.ISO15765_11_250:
        return 'ISO 15765-4 (CAN 11bit 250K)';
      case OBDProtocol.ISO15765_29_250:
        return 'ISO 15765-4 (CAN 29bit 250K)';
      case OBDProtocol.SAE_J1939:
        return 'SAE J1939 (CAN 29bit 250K)';
      default:
        return 'Unknown';
    }
  }
