...
export interface Elm327SppTarget {
    ...
    serviceUUID: string; // The UUID of the primary service
    writeCharacteristicUUID: string; // The UUID for sending commands (often WriteWithoutResponse)
    notifyCharacteristicUUID: string; // The UUID for receiving responses (Notify)
  }
  ...
  export const ELM327_PROMPT_BYTE = 0x3e; // ASCII code for '>'
